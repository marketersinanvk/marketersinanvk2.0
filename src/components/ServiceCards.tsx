  ...
  return (
    <div className="w-full h-full p-1 flex flex-col items-center relative overflow-hidden bg-black border-[6px] border-[#1a1a1a] rounded-[60px] shadow-[0_0_100px_rgba(0,0,0,0.8),0_0_20px_rgba(57,255,20,0.05)]">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='80' height='80' viewBox='0 0 80 80' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M40 0l10 30h30l-25 20 10 30-25-20-25 20 10-30-25-20h30z' fill='%236366f1'/%3E%3C/svg%3E")`,
      ...
      <div className="w-full h-full flex flex-col items-center pt-24 px-6 relative z-10">
        ...
        >
          ...
          <div>
            <h4 className="text-vibrant-indigo text-[10px] font-bold uppercase tracking-wider">Marketer Sinan VK</h4>
        ...
        <div className="w-full space-y-2.5 max-h-[380px] overflow-hidden relative">
          {notifications.map((notif, i) => (
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-vibrant-indigo group-hover:text-white transition-all duration-500">
                <notif.icon className="w-5 h-5 text-vibrant-indigo group-hover:text-white transition-colors" />
              </div>
          ...
          >
            ...
            <div className="space-y-8">
              <div className="space-y-2">
                <p className="text-vibrant-indigo text-[9px] font-bold uppercase tracking-[0.5em]">The Initiation</p>
              ...
              <form onSubmit={handleWhatsAppSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input 
                    ...
                    className="w-full glass-2 bg-white/[0.02] border border-white/5 rounded-full px-6 py-4 text-xs text-white placeholder:text-silver/10 focus:outline-none focus:border-vibrant-indigo/30 transition-all"
                  />
                </div>
                <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea 
                    ...
                    className="w-full glass-2 bg-white/[0.02] border border-white/5 rounded-[24px] px-6 py-4 text-xs text-white placeholder:text-silver/10 focus:outline-none focus:border-vibrant-indigo/30 transition-all resize-none"
                  />
                </div>
      ...
      <motion.div 
        ...
        whileHover={{ scaleX: 1.1, backgroundColor: "rgba(99, 102, 241, 0.4)" }}
        drag="y"
      ...
      >
        {/* Tooltip for Desktop */}
        <div className="absolute -top-10 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap text-[8px] font-bold text-vibrant-indigo uppercase tracking-widest bg-black/80 px-3 py-1.5 rounded-full border border-vibrant-indigo/20 backdrop-blur-md">
