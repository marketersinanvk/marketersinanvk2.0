  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[100]">
      ...
      <motion.a
        ...
        className="absolute bottom-6 right-6 sm:bottom-10 sm:right-10 w-14 h-14 sm:w-16 sm:h-16 bg-neon-green text-midnight rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(57,255,20,0.4)] pointer-events-auto group"
      >
      ...
      <div className="absolute bottom-6 left-6 sm:bottom-10 sm:left-10 pointer-events-auto">
        <AnimatePresence>
          {isChatOpen && (
            ...
            >
              <div className="p-6 bg-neon-green/10 border-b border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-neon-green/40 text-[8px] uppercase tracking-widest">Online</p>
                  </div>
                </div>
              ...
              <div className="p-4 border-t border-white/5 flex gap-2">
                <input 
                  ...
                  className="flex-1 bg-white/5 border border-white/5 rounded-full px-4 py-2 text-xs text-white focus:outline-none focus:border-neon-green/30 transition-all"
                />
                <button className="w-8 h-8 bg-neon-green text-midnight rounded-full flex items-center justify-center hover:scale-110 transition-transform">
                  <Send size={14} />
                </button>
              </div>
            </motion.div>
        ...
        <motion.button
          ...
          animate={{ scale: 1, opacity: 1 }}
          whileHover={{ scale: 1.1 }}
          className="w-14 h-14 sm:w-16 sm:h-16 glass-2 rounded-full flex items-center justify-center text-neon-green shadow-[0_0_30px_rgba(57,255,20,0.2)] group"
        >
