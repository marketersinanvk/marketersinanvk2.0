  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[100]">
      ...
      <motion.a
        ...
        className="absolute bottom-6 right-6 sm:bottom-10 sm:right-10 w-12 h-12 sm:w-14 sm:h-14 bg-vibrant-indigo text-white rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(99,102,241,0.3)] pointer-events-auto group"
      >
      ...
      <div className="absolute bottom-6 left-6 sm:bottom-10 sm:left-10 pointer-events-auto">
        <AnimatePresence>
          {isChatOpen && (
            <motion.div
              ...
              className="absolute bottom-20 left-0 w-80 glass-2 rounded-[30px] overflow-hidden shadow-2xl border border-vibrant-indigo/20"
            >
              <div className="p-6 bg-vibrant-indigo/5 border-b border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-vibrant-indigo/20 rounded-full flex items-center justify-center">
                    <MessageSquare size={16} className="text-vibrant-indigo" />
                  </div>
                  <div>
                    <h4 className="text-white text-[10px] font-bold uppercase tracking-widest">Sinan AI</h4>
                    <p className="text-vibrant-indigo/40 text-[8px] uppercase tracking-widest">Active</p>
                  </div>
                </div>
              ...
              <div className="p-4 border-t border-white/5 flex gap-2">
                <input 
                  ...
                  className="flex-1 bg-white/5 border border-white/5 rounded-full px-4 py-2 text-xs text-white focus:outline-none focus:border-vibrant-indigo/30 transition-all"
                />
                <button className="w-8 h-8 bg-vibrant-indigo text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform">
                  <Send size={14} />
                </button>
              </div>
            </motion.div>
        ...
        <motion.button
          ...
          animate={{ scale: 1, opacity: 1 }}
          whileHover={{ scale: 1.1 }}
          className="w-14 h-14 sm:w-16 sm:h-16 glass-2 rounded-full flex items-center justify-center text-vibrant-indigo shadow-[0_0_30px_rgba(99,102,241,0.2)] group border border-vibrant-indigo/20"
        >
