    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              >
                <Link to={stat.link} className="block p-8 glass-2 rounded-[30px] border border-white/5 hover:border-neon-blue/30 transition-all duration-500">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-neon-blue/10 rounded-2xl flex items-center justify-center text-neon-blue group-hover:bg-neon-blue group-hover:text-midnight transition-all duration-500">
                      <stat.icon size={24} />
                    </div>
                    <p className="text-neon-blue text-3xl md:text-4xl font-serif italic tracking-tighter">{stat.value}</p>
                  </div>
      ...
      <section className="py-24 md:py-40 px-6 sm:px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          >
            <h2 className="text-neon-blue text-[9px] font-bold uppercase tracking-[0.5em]">The Philosophy</h2>
            <h3 className="text-5xl sm:text-6xl md:text-8xl font-serif tracking-tighter text-white leading-[1.1] md:leading-[0.85]">
              Engineering <br />
              <span className="italic text-neon-blue">Digital</span> <br />
              Legacies.
            </h3>
            <p className="text-silver/50 text-lg md:text-xl font-light leading-relaxed tracking-wide max-w-lg">
              ...
              Specializing as a <Link to="/services" className="text-neon-blue hover:underline decoration-neon-blue/30 underline-offset-4 hover:shadow-[0_0_15px_rgba(0,243,255,0.3)] transition-all">Meta Ads Expert</Link> and 
              <Link to="/services" className="text-neon-blue hover:underline decoration-neon-blue/30 underline-offset-4 hover:shadow-[0_0_15px_rgba(0,243,255,0.3)] transition-all">SEO Analyst</Link>, 
              we engineer every interaction as an intentional step towards market dominance in <Link to="/contact" className="text-neon-blue hover:underline decoration-neon-blue/30 underline-offset-4">Palakkad, Kerala</Link> and Dubai.
            </p>
            <button className="px-10 py-5 md:px-12 md:py-6 glass-2 border border-neon-blue/20 text-neon-blue font-bold rounded-full hover:bg-neon-blue hover:text-midnight transition-all duration-700 uppercase tracking-[0.2em] text-[10px] w-full sm:w-auto">
              The Manifesto
            </button>
          </motion.div>
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="aspect-[4/5] glass-2 rounded-[40px] sm:rounded-[80px] overflow-hidden group">
              <img 
                src="https://picsum.photos/seed/philosophy-luxury/1000/1250.webp" 
                alt="Muhammed Sinan VK - Digital Marketing Philosophy in Palakkad" 
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-6 -right-6 sm:-bottom-12 sm:-right-12 w-40 h-40 sm:w-56 sm:h-56 glass-2 rounded-full border border-neon-blue/10 flex items-center justify-center p-6 sm:p-10 animate-pulse">
              <p className="text-neon-blue text-[7px] sm:text-[8px] font-bold uppercase tracking-[0.4em] text-center leading-loose">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-start">
            <div className="space-y-8 md:space-y-12 lg:sticky lg:top-40">
              <div className="space-y-4 md:space-y-6">
                <p className="text-neon-blue text-[9px] font-bold uppercase tracking-[0.5em]">The Initiation</p>
                <h2 className="text-6xl sm:text-7xl md:text-9xl font-serif tracking-tighter text-white leading-[1.1] md:leading-[0.85]">
                  Let's <br />
                  <span className="italic text-neon-blue">Collaborate.</span>
                </h2>
              </div>
