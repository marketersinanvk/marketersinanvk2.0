    ...
    <footer className="border-t border-white/5 pt-32 pb-16 px-8 overflow-hidden relative grainy">
        ...
        <div className="space-y-10">
          ...
          <ul className="space-y-5">
            {[
              ...
              <li key={item.name}>
                <Link to={item.path} className="text-silver/40 hover:text-neon-green text-xs font-light tracking-widest transition-colors duration-500 uppercase">
                  {item.name}
                </Link>
              </li>
            ))}
        ...
        <div className="space-y-10">
          ...
          <ul className="space-y-6">
            <li className="flex items-start gap-4">
              <MapPin className="w-4 h-4 text-neon-green shrink-0 mt-1" />
              <Link to="/contact" className="text-silver/40 text-xs font-light leading-relaxed tracking-wide hover:text-neon-green transition-colors">
      ...
      <div className="max-w-7xl mx-auto mt-32 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10 relative z-10">
        ...
        <div className="flex gap-12">
          <a href="#" className="text-silver/20 hover:text-neon-green text-[9px] font-bold uppercase tracking-[0.5em] transition-colors">Privacy</a>
          <a href="#" className="text-silver/20 hover:text-neon-green text-[9px] font-bold uppercase tracking-[0.5em] transition-colors">Terms</a>
        </div>
      </div>
